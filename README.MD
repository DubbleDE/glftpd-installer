...
**Debian**
``` 
apt-get install autoconf bc curl diffutils ftp git libflac-dev libssl-dev lm-sensors lynx make mariadb-server mkvtoolnix ncftp passwd smartmontools tcl tcl-dev tcl-tls tcpd zip
``` 
